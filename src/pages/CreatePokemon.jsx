...
const CreatePokemon = () => {
  ...
  const handleCreatePokemon = async () => {
    ...
    try {
        const response = await api.post("/pet/create", { alias, species });
            ...
            <div className="side-rectangle">
              <form className="alias-form">
                ...
                <p className="attention-text">
                  *Atención, una vez le asignes un nombre a tu mascota no se
                  podrá cambiar.
                </p>
              </form>
              <form className="species-form">
                <label htmlFor="species" className="species-label">
                  Y su especie será...
                </label>
                <select
                  id="species"
              ...
              <button className="create-button" onClick={handleCreatePokemon}>
                Crear Pokémon
              </button>
            </div>
          </div>
